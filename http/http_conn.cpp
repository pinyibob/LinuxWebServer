...
http_conn::HTTP_CODE http_conn::do_request()
{
    ...
    else if(strcmp(cmd_name, "clear_message") == 0)
    {
        _chat_imp.reset();
        return NO_REQUEST;
    }
...
bool http_conn::add_headers_response(int content_len)
{
    return add_response("Content-Type:%s\r\n", "application/json") &&
     add_content_length(content_len) && add_blank_line();
}
...
bool http_conn::add_accept(const char* msg)
{
    return add_response("%s", msg);
}
